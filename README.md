...
Notes/
├─ CitySample学习笔记.md                单一主线的 Obsidian/Markdown 学习笔记
...
建议先阅读 [CitySample 学习笔记](Notes/CitySample学习笔记.md)，其中按照“是什么、为什么、怎么做”沿同一条学习主线记录完整实验过程、Report 数据、Python 命令和排错结论。
